...
RcppExport SEXP _covid19_model_sa2_InstallTime() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    rcpp_result_gen = Rcpp::wrap(InstallTime());
...
// do_au_simulate
List do_au_simulate(IntegerVector StatusOriginal, IntegerVector InfectedOnOriginal, IntegerVector SA2, IntegerVector hid, IntegerVector Age, IntegerVector School, IntegerVector DZN, IntegerVector wid, IntegerVector nColleagues, IntegerVector PlaceTypeBySA2, IntegerVector LabourForceStatus, IntegerVector SeedOriginal, List Policy, List MultiPolicy, List nPlacesByDestType, List Epi, /* Epidemiological parameters */                     IntegerVector unseen_infections, IntegerVector overseas_arrivals, IntegerVector Incubation, IntegerVector Illness, IntegerVector nSupermarketsAvbl, IntegerVector SupermarketTypical, List minPlaceID_nPlacesByDestType, const int yday_start, const int days_to_sim, const int N, int returner, bool display_progress, bool on_terminal, int console_width, int optionz, int nThread);
RcppExport SEXP _covid19_model_sa2_do_au_simulate(SEXP StatusOriginalSEXP, SEXP InfectedOnOriginalSEXP, SEXP SA2SEXP, SEXP hidSEXP, SEXP AgeSEXP, SEXP SchoolSEXP, SEXP DZNSEXP, SEXP widSEXP, SEXP nColleaguesSEXP, SEXP PlaceTypeBySA2SEXP, SEXP LabourForceStatusSEXP, SEXP SeedOriginalSEXP, SEXP PolicySEXP, SEXP MultiPolicySEXP, SEXP nPlacesByDestTypeSEXP, SEXP EpiSEXP, SEXP unseen_infectionsSEXP, SEXP overseas_arrivalsSEXP, SEXP IncubationSEXP, SEXP IllnessSEXP, SEXP nSupermarketsAvblSEXP, SEXP SupermarketTypicalSEXP, SEXP minPlaceID_nPlacesByDestTypeSEXP, SEXP yday_startSEXP, SEXP days_to_simSEXP, SEXP NSEXP, SEXP returnerSEXP, SEXP display_progressSEXP, SEXP on_terminalSEXP, SEXP console_widthSEXP, SEXP optionzSEXP, SEXP nThreadSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< List >::type MultiPolicy(MultiPolicySEXP);
    ...
    Rcpp::traits::input_parameter< /* Epidemiological parameters */                     IntegerVector >::type unseen_infections(unseen_infectionsSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type overseas_arrivals(overseas_arrivalsSEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type Incubation(IncubationSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type nThread(nThreadSEXP);
    rcpp_result_gen = Rcpp::wrap(do_au_simulate(StatusOriginal, InfectedOnOriginal, SA2, hid, Age, School, DZN, wid, nColleagues, PlaceTypeBySA2, LabourForceStatus, SeedOriginal, Policy, MultiPolicy, nPlacesByDestType, Epi, unseen_infections, overseas_arrivals, Incubation, Illness, nSupermarketsAvbl, SupermarketTypical, minPlaceID_nPlacesByDestType, yday_start, days_to_sim, N, returner, display_progress, on_terminal, console_width, optionz, nThread));
    return rcpp_result_gen;
END_RCPP
}
// do_exp_dbl2int
...
RcppExport SEXP _covid19_model_sa2_sum_le_eq(SEXP xSEXP, SEXP x1SEXP, SEXP ySEXP, SEXP y1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(sum_le_eq(x, x1, y, y1));
    return rcpp_result_gen;
END_RCPP
}
// do_is_unsorted_pint
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_covid19_model_sa2_sum_le_eq", (DL_FUNC) &_covid19_model_sa2_sum_le_eq, 4},
