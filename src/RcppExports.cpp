...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type nThread(nThreadSEXP);
    rcpp_result_gen = Rcpp::wrap(do_au_simulate(StatusOriginal, InfectedOnOriginal, SA2, hid, Age, School, DZN, wid, nColleagues, PlaceTypeBySA2, LabourForceStatus, SeedOriginal, Policy, MultiPolicy, nPlacesByDestType, Epi, unseen_infections, overseas_arrivals, Incubation, Illness, nSupermarketsAvbl, SupermarketTypical, minPlaceID_nPlacesByDestType, yday_start, days_to_sim, N, display_progress, on_terminal, returner, console_width, optionz, nThread));
    return rcpp_result_gen;
END_RCPP
}
// do_exp_dbl2int
