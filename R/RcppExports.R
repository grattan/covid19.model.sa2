...
do_au_simulate <- function(StatusOriginal, InfectedOnOriginal, SA2, hid, Age, School, DZN, wid, nColleagues, PlaceTypeBySA2, LabourForceStatus, SeedOriginal, Policy, MultiPolicy, nPlacesByDestType, Epi, unseen_infections, overseas_arrivals, Incubation, Illness, nSupermarketsAvbl, SupermarketTypical, minPlaceID_nPlacesByDestType, yday_start, days_to_sim, N, returner = 0L, display_progress = TRUE, on_terminal = FALSE, console_width = 80L, optionz = 0L, nThread = 1L) {
